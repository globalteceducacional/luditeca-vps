...
export async function registerAuthRoutes(app) {
    ...
    app.post('/auth/forgot-password', async (request, reply) => {
        ...
        if (user) {
            ...
            if (resetLink) {
                ...
                request.log.warn('PASSWORD_RESET_PUBLIC_BASE_URL não definido; defina para obter o link completo nos logs de servidor.');
    ...
    app.patch('/me/profile', { preHandler: requireAuth }, async (request, reply) => {
        ...
        if (body.icone !== undefined)
            profileData.icone = body.icone;
        if (body.progress !== undefined)
            profileData.progress = parseJsonMap(body.progress);
