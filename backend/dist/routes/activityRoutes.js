...
import { isActivityType, parseBoolean, parsePagination, validateActivityPayload, } from '../lib/contentTypes.js';
...
export async function registerActivityRoutes(app) {
    app.get('/activities', { preHandler: requireCmsEditor }, async (request, reply) => {
    ...
    app.get('/activities/:id', { preHandler: requireCmsEditor }, async (request, reply) => {
    ...
    app.post('/activities', { preHandler: requireCmsEditor }, async (request, reply) => {
        ...
        const row = await prisma.activity.create({
            data: {
                ...
                badgeReward: body.badge_reward != null || body.badgeReward != null
    ...
    app.patch('/activities/:id', { preHandler: requireCmsEditor }, async (request, reply) => {
        const body = request.body;
        const data = {};
        ...
        if (body.questions !== undefined) {
            data.questions = (Array.isArray(body.questions) ? body.questions : []);
        }
    ...
    app.delete('/activities/:id', { preHandler: requireCmsEditor }, async (request, reply) => {
