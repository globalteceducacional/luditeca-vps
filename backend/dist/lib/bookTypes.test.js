...
import { normalizeBookQuiz, parseBookType, validateBookTypePages, validateDigitalBookAssets, } from './bookTypes.js';
...
describe('validateDigitalBookAssets', () => {
    ...
    it('exige pdf ou epub quando publicado', () => {
        ...
        expect(validateDigitalBookAssets({ pdf_url: 'https://x/a.pdf' }, { workflowStatus: 'published' }).ok).toBe(true);
    });
});
