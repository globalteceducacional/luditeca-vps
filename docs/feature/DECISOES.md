...
| 2026-05-18 | **App infantil:** API `/app/*` + UI em `/app` (library com leitor v2, atividades, LIBRAS, puzzle, pinturas). Players puzzle/coloring completos adiados. | Provisório |
